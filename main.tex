...
% título
\title{Ainda estou pensando em um título legal para minha dissertação}

% palavras-chave e keywords (p/ resumo, abstract e metadados do PDF)
\pchave{Sarcasmo. BERT. LSTM.}
\keyword{Sarcasm. BERT. LSTM.}

% autoria
\author{Giordano Henrique Silveira}
\advisor{Fabiano Silva}
...
\include{3-trabalhos_relacionados/texto}		% proposta
\include{4-modelo_proposto/texto}			% estado da arte
\include{5-avaliacao_experimental/texto}		% experimentação e validação
\include{6-conclusao/texto}		% conclusão
% \include{7-maziero/texto}		% conclusão
% \include{8-resultados/texto}		% conclusão
